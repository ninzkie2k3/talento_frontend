...
export default function AddBookSolo() {
...
return (
    ...
    performers.map((performer, index) => (
            <Card key={index} sx={{ mb: 4 }}>
                    <CardContent sx={{ display: 'flex', alignItems: 'center' }}></CardContent>
                    <CardContent>
                         <Avatar
                             src={
                                performer?.performer_portfolio?.image_profile
                                        ? `https://palegoldenrod-weasel-648342.hostingersite.com/backend/talentoproject_backend/public/storage/${performer.performer_portfolio.image_profile}`
                                        : ''
                        }
                        alt={performer?.name || ''}
                ...
                />
                            <Box>
                                    <Typography variant="h5">{performer?.name || "Name not available"}</Typography>
                                    <Typography variant="body1">
                                            <strong>Talent:</strong> {performer?.performer_portfolio?.talent_name || "Not specified"}
                                    </Typography>
                                    <Typography variant="body1">
                                            <strong>Rate:</strong> {performer?.performer_portfolio?.rate || 0} TCoins
                                    </Typography>
                                    <Typography variant="body1">
                                            <strong>Location:</strong> {performer?.performer_portfolio?.location || "Not specified"}
                                    </Typography>
                                    <Box>
                                            <Rating value={Number(performer?.performer_portfolio?.average_rating) || 0} readOnly />
                                    </Box>
                            </Box>
                    </CardContent>
            </Card>
    ...
    <Typography>No performers selected for booking.</Typography>
)}
